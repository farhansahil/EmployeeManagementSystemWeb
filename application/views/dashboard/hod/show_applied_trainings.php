...
<section class="px-4 pt-5 mt-4 sec-main my-container">
    ...
    <div class="container py-4">
        ...
        <div class="container container_new">
            ...
            <form action="<?php echo base_url().'Hod/HodController/show_applied_trainings'?>" name="mainForm"
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="status" id="status" style="width: 250px; margin-bottom: 20px">
                            ...
                            <option value=<?php echo $status['id'] ?><?php echo set_select('status', $status['id']) ?>>
                    ...
                    <div class="form-group">
                        <input type="submit" name="signin" id="signin" class="btn btn-primary" value="Search"
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th scope="row">
                                <a href="<?php echo base_url() . "Hod/HodController/accept_training_application/" . $training['id'] ?>"
                                    style="
                                font-size: 12px; border-radius: 5px" class="btn btn-success"> Accept
                                </a>
                            </th>
                            <th scope="row">
                                <a href="<?php echo base_url() . "Hod/HodController/decline_training_application/" . $training['id'] ?>"
                                    style="
