                    ...
                    <form action="<?php echo base_url().'index.php/Auth/RegisterController/editDetails'?>" name="registerForm" id="registerForm signupform" class="signupform" method="post">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <?php if (!empty($employee_details)) {foreach ($employee_details as $employees_details) {?>

                                <input type="text" name="first_name" id="first_name" value="<?php echo $employees_details['first_name'] ?>" class="form-input form-control <?php echo (form_error('first_name') !=  "") ? 'is-invalid' : '' ?>" placeholder="First Name">
                                <?php }} ?>
